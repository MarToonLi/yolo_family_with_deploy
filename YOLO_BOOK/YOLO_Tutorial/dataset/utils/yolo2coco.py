...
if __name__ == '__main__':
    ...
    parser.add_argument('--anno-path', type=str,default=r'F:\Projects\datasets\Hellen-Apple\3_7_yolo\labels\train',  required=False, help='Directory path to YOLO annotations')
    parser.add_argument('--image-path', type=str,default=r'F:\Projects\datasets\Hellen-Apple\3_7_yolo\images\train', required=False, help='Directory path to images')
    parser.add_argument('--save-path', type=str,default=r'F:\Projects\datasets\Hellen-Apple\3_7_coco\annotations',  required=False, help='Directory path to save COCO formatted annotation')
