...
class YOLO11:
    ...
    def initialize_model(self):
        ...
        visual_img = self.postprocess(self.img, outputs)  # 输出图像
        
        
        
        # 循环加载指定图像并推理图像数据，计算时间，计算FPS
        import time
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default=r"D:\ProjectsRelated\CoreProjects\yolo_family_with_deploy\runs\detect\train6\weights\best.onnx", help="输入你的 ONNX 模型路径。")
    parser.add_argument("--img", type=str, default=r"E:\Resources\datasets\JY\jy_steelvol_v1\t4_part2_b6\side_20240906170655.jpg", help="输入图像的路径。")
    ...
    # 执行目标检测并获取输出图像
    _ = detection.initialize_model()
    
    output_image = detection.infer_single_image(r"E:\Resources\datasets\JY\jy_steelvol_v1\t4_part2_b6\side_20240907211939.jpg")
