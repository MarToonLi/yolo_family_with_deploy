...
if __name__ == '__main__':
    model = YOLO(r'/ns_data/projets/yolo_family_with_deploy/yolov11/ultralyticsx/cfg/models/11/yolo11s.yaml')
    ...
    model.load(r'/ns_data/projets/yolo_family_with_deploy/resources/models/yolov11/yolo11s.pt') 
    # 是否加载预训练权重,科研不建议大家加载否则很难提升精度
    model.train(data=r"/ns_data/projets/yolo_family_with_deploy/yolov5_7.0/data/cable/apple_3_7_train_remote.yaml",
