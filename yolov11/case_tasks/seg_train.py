...
if __name__ == '__main__':
    ...
    model_yaml_path = os.path.join(root_path, r'yolov11\ultralyticsx\cfg\models\11\yolo11s-seg.yaml')
    pretrained_weights_path = os.path.join(root_path, r'resources/models/yolov11/yolo11s.pt')
    data_yaml_path = os.path.join(root_path, r'datasets\jingye\flysteel_jingye.yaml')
