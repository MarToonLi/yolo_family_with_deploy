...
nohup python ../../train_little.py --device 0 --batch 24 --epochs 100 --cache --imgsz 1120 --cos-lr --image-weights --hyp '/root/lanyun-tmp/projects/yolo_family_with_deploy/yolov5_7.0/data/hyps/apple_3_7_hyp_little_lr.yaml' > output_train_lr.log 2>&1 &
# pid=$!   # 上一个在后台运行（&）的命令的进程 ID（PID）
# wait $pid
...
# nohup python ../../train_mmodel.py --device 0 --batch 24 --epochs 500 --cache --imgsz 1120 --cos-lr --image-weights > output_train_mmodel.log 2>&1 &
